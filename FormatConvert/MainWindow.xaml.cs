...
namespace FormatConvert
{
    public sealed partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            //contentFrame.Navigate(typeof(FormatConvertPage));
        ...
        private void NavigationView_SelectionChanged(NavigationView sender, NavigationViewSelectionChangedEventArgs args)
        {
            ...
            else
            {
                ...
                if ((string)selectedItem.Tag == "FormatConvertPage") contentFrame.Navigate(typeof(FormatConvertPage));
                //else if ((string)selectedItem.Tag == "APKInstallPage") contentFrame.Navigate(typeof(APKInstallPage));
            }
